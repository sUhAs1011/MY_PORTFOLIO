...
with col1:
    ...
    "</div>",
    unsafe_allow_html=True)
    st.markdown("<div class='subtitle'>CSE Senior at PES University | Project Engineering Intern at Elfonze Technologies</div>", unsafe_allow_html=True)
    st.markdown("""<p style='font-size:18px; line-height:1.6;'>
Final-year Computer Science & Engineering student at PES University, currently working as a Project Engineering Intern at Elfonze Technologies. 
...
with col2:
    ...
    <div style="font-size:18px; line-height:1.6; text-align: left;">
        I’m <strong>Suhas Venkata Karamalaputti</strong>, a final-year Computer Science & Engineering student at PES University, currently working as a <strong>Project Engineering Intern</strong> at Elfonze Technologies. 
