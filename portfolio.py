...
# --- PAGE CONFIG ---
st.set_page_config(page_title="Suhas Venkata Karamalaput · Portfolio", page_icon="suhas.jpg", layout="wide")
...
/* Disable hover effects on mobile for better performance and readability */
...
with col1:
    ...
    "</div>",
    unsafe_allow_html=True)
    st.markdown("<div class='subtitle'>CSE Senior at PES University | Project Intern at Elfonze Technologies</div>", unsafe_allow_html=True)
    st.markdown("""<p style='font-size:18px; line-height:1.6;'>
Final-year Computer Science & Engineering student at PES University, currently working as a Project Intern at Elfonze Technologies. 
...
with col2:
    ...
    <div style="font-size:18px; line-height:1.6; text-align: left;">
        I’m <strong>Suhas Venkata Karamalaputti</strong>, a final-year Computer Science & Engineering student at PES University, currently working as a <strong>Project Intern</strong> at Elfonze Technologies. 
...
ml_tools = ["Scikit-learn", "Pandas", "NumPy", "NLTK", "Spacy", "PyTorch", "Mathplotlib", "Keras", "Seaborn", "Selenium","Tensorflow","OpenCV"]
...
.achievement-card:hover {
    ...
    box-shadow: 0 15px 30px rgba(0, 0, 0, 0.4), 0 0 15px rgba(0, 198, 251, 0.2);
...
.experience-card {
    background: #111827;
    /* border-left: 4px solid #00C6FB; removed as per request */
    border-radius: 8px;
    padding: 25px;
    margin-bottom: 30px;
    box-shadow: 0 4px 6px rgba(0,0,0,0.1);
